package baliviya.com.github.eduBot.util.components;
...
public class DateKeyboard {
    ...
    private java.lang.String buttonBackMonth = "◄";
    private java.lang.String buttonNextMonth = "►";
    private java.lang.String buttonBackYear = "◄◄";
    private java.lang.String buttonNextYear = "►►";
    ...
    public boolean isNext(String updateText) {
        ...
        if (updateText.equals(emptyValue) || updateText.equals(formatYear.format(startDay.getTime())) ||
    ...
    public java.lang.String getDate(java.lang.String updateText) {
        try {
            if (updateText.length() > 2) {
                return null;
            }
            int day = Integer.parseInt(java.lang.String.valueOf(updateText));
    ...
    public Calendar getCalendarDate(java.lang.String updateText) {
    ...
    public Date getDateDate(java.lang.String updateText) {
        return getCalendarDate(updateText).getTime();
    }

    public InlineKeyboardMarkup getCalendarKeyboard() {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd");
        ArrayList<java.lang.String> listButtons = new ArrayList<>();
    ...
    private InlineKeyboardMarkup getInlineKeyboard(String[] namesButton) {
        ...
        for (int i = 0; i < namesButton.length; i++) {
            ...
            java.lang.String[] buttonIds = buttonIdsString.split(",");
            for (java.lang.String buttonId : buttonIds) {
